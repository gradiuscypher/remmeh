...
- [ ] **CHAT-05**: API errors, rate limits, and timeouts are displayed inline in the chat thread — app does not crash
- [ ] **CHAT-06**: OpenRouter API key is loaded from a `.env` file at startup
